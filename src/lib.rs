    ...
    rocket::custom(config::from_env())
        .mount(
            ...
            routes![
                ...
                routes::requests::get_friend_requests,
                routes::requests::request_friend,
                routes::requests::accept_friend,
                routes::requests::cancel_friend,
                routes::requests::decline_friend,
